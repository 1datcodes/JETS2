            ...
            <section className="homepage-content">
                <div className="book-lesson">
                    <div className="book-lesson-text">
                        ...
                        <div className="handy-buttons">
                            <a className="book-lesson-button" href="https://forms.gle/VNosV8pXzE58j2A1A" target="_blank" rel="noreferrer noopener" aria-disabled="false">レッスンを予約する</a> 
                            <a className="send-message-button" href="https://forms.gle/Dy22nkreZSpqjMADA" target="_blank" rel="noreferrer noopener" aria-disabled="false">お問い合わせ</a>    
                        </div>
                    </div>
                ...
                <div className="why-us">
                    <div className="why-us-title">
                        <h2>なぜJETS？</h2>
                        <div className="bar" />
                        <a href="/about" className="link-to-about">JETSについて</a>
                    </div>
                    <div className="benefits-panel">
                        ...
                        <div>
                            <svg preserveAspectRatio="xMidYMid meet" data-bbox="36.5 29.499 127 141.001" viewBox="36.5 29.499 127 141.001" height="200" width="200" xmlns="http://www.w3.org/2000/svg" data-type="color" role="presentation" aria-hidden="true" aria-label="">
                                <g>
                        ...
                        <div>
                            <svg preserveAspectRatio="xMidYMid meet" data-bbox="30 33 140.001 134.001" viewBox="30 33 140.001 134.001" height="200" width="200" xmlns="http://www.w3.org/2000/svg" data-type="color" role="presentation" aria-hidden="true" aria-label="">
                                <g>
