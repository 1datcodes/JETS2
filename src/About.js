  ...
  },
  {
    ...
    [
      ...
      },
      {
        ...
        name: "畑山香穂（はたやまかほ）",
        image: "hatayama.jpg",
        message: `こんにちは。私は日本に小学6年生まで住んでいて、アメリカ住んで5年です。
      ...
      },
      {
        ...
        name: "牛山翔矢（うしやましょうや）",
        image: "ushiyama.jpg",
        message: `始めまして、中学2年生に日本からアメリカに来て、三育に一年半、
      ...
      },
      {
        ...
        name: "古藤慶次（ことうけいじ）",
        image: "",
        message: `こんにちは、補習校は8年目になります。サッカー、病気、現地校の掛け持ちするのがとても大変でした。
      ...
      },
      {
        ...
        name: "河合静（かわいしずか）",
        image: "",
        message: `こんにちは。私は小学2年生から補習校に通い、5年生から並行してENA でもクラスをとっています。
